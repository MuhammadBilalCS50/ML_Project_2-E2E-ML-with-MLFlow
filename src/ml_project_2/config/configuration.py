...
from ml_project_2.entity.config_entity import DataIngestionConfig, DataValidationConfig, DataTransformationConfig, ModelTrainerConfig, ModelEvaluationConfig
...
class ConfigurationManager:
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        ...
        model_evaluation_config = ModelEvaluationConfig(
            ...
            target_column = schema.name,
            mlflow_uri="https://dagshub.com/MuhammadBilalCS50/ML_Project_2-E2E-ML-with-MLFlow.mlflow",
